...
$Id:  plotW_CosInc.py, v 5.0 12/03/2015
...
v5: Updated for the final pilot paper results (12/03/15)
    unfinished, see plotW_CosInc2.py for working version
...
def main():
    ...
    if getpass.getuser() == 'David':
        pickleFilename = '/Users/David/Research_Documents/inclination/pilotData3.p'
        saveDirectory = '/Users/David/Research_Documents/inclination/git_inclination/pilot_paper_code/plots/'

    elif getpass.getuser() == 'frenchd':
        pickleFilename = '/usr/users/frenchd/inclination/git_inclination/pilotData3.p'
