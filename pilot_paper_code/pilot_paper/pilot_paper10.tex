...
\begin{figure}[t!]
\centering
  \subfigure[]{\includegraphics[width=0.87\linewidth]{MRK290_system-3090_cut.pdf}}{\label{line}}
  \subfigure[]{\includegraphics[width=1.\linewidth]{map_MRK290_3207_v5.pdf}\label{impactmap}}
...
\subfigure[]{\label{impact_vir}\includegraphics[width=0.49\textwidth]{impact(virial)_50_difHistograms3.pdf}}
...
%Hence, there is less than a $1\%$ probability that the inclinations of our associated galaxies are sampled from the average distribution of observed inclinations (comparable to $\sim 3.6 \sigma$ for a normal distribution).

%Hence, there is less than a $1\%$ probability ($3\sigma$) that our associated galaxies are sampled from the average distribution of galaxies within this survey volume. 
